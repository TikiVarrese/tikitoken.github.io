  ...
  return (
    ...
    >
      <div className="flex items-center">
        ...
        <span>{(text !== undefined && text !== '' && (text.substring(0, 2) === '0x')) ? holdings < 10000 ? text + ' - YOU NEED TO HOLD MORE THAN 10K TIKI TO RECEIVE DIVIDENDS' : text : 'Please connect you wallet above'}</span>
      </div>
