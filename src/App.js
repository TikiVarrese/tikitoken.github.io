...
console.log(tikiStakingContract);
...
function getTikiDividenTrackerTokenSupply() {
  return 1000000000
}
...
function App() {
  ...
  useEffect(() => {
    ...
    setTikiEarningSupplyTotal(getTikiDividenTrackerTokenSupply())
  }, [])
  ...
  useEffect(() => {
    ...
    //tikiStakingContract.updateVault(getMetamaskWallet()).then(total => {
    //  console.log(total)
    //})
  }, [refreshTimeData])
